...
export const metadata = {
  ...
  description: "Find top creators from across Southeast Asia for your next project. Trusted by leading companies, our platform simplifies the hiring process for both parties.",
  openGraph: {
    title: "Discover UGC Creators, Brand Deals and Creator Marketing Solutions with SEA’s Chosen Platform",
  },
  alternates: {
