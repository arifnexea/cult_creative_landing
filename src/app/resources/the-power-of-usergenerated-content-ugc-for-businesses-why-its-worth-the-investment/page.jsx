...
export const metadata = {
  title: title,
  description: "UGC transforms businesses by humanising brands in a social-media landscape that values authenticity. Cult Creative is a strategic partner for businesses looking to expand their brand reach organically.",
  keywords: keywords,
  openGraph: {
  ...
  return (
    <>
      <rp.Page keywords={keywords}>
        ...
        <rp.p>
          As explained in{" "}
          <rp.a href="/resources/what-is-ugc">
            this blog post
          </rp.a>,
        ...
        <rp.p>
          One of the biggest benefits of working with content creators include gaining access to an existing community of followers.
        ...
        <rp.p>
          As social media becomes oversaturated with polished and professional content, younger audiences crave authenticity and relatability.
        ...
        <rp.p>
          ...
          businesses will be able to boost their credibility when social media users see content creators endorsing their products.
        </rp.p>

        <rp.h2>Fosters Creativity</rp.h2>
        <rp.p>
          One glaring problem with organic UGC is its unpredictability.
        ...
        <rp.p>
          ...
          <rp.a href="https://www.insg.co/en/influencer-marketing-malaysia/">
            influencer-advertising market in Malaysia projected to reach approximately US$102.30 million by 2028
          </rp.a>,
        ...
        <rp.p>
          ...
          offer flexible and cost-effective UGC packages that suit the marketing needs of every company, from new businesses to established companies.
          They make it really easy to dive into this exciting and new marketing strategy.
        </rp.p>
      </rp.Page>
    </>
  );
